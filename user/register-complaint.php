...
if (!empty($_FILES["compfile"]["name"])) {
    $compfile = $_FILES["compfile"]["name"];
    $extension = substr($compfile, strlen($compfile) - 4, strlen($compfile));

    // Check if the file format is allowed
    if (!in_array($extension, array(".jpg", ".jpeg", ".png", ".gif", ".pdf", ".PDF", ".doc", "docx"))) {
        ...
        // Insert data into the database with a file
    ...
    // If no file is uploaded, insert data into the database without a file
